...
Данный скрипт показывает как настраивается мониторинг для Linux сервера.
...
- Делает загруженный шаблон избранным, чтобы он сразу открывался при входе в Grafana
...
```
Примечание: Повторный запуск скрипта удаляет текущие докеры контейнеры и их volumes, затем процесс установки повторяется.
...
Скрипт сделан по мотивам инструкции grafana-prometheus-guide.md,  как алтернативный способ установки системы мониторинга для систем на базе Ubuntu Linux.
