...
```bash
# Скачайте скрипт
wget [https://raw.githubusercontent.com/almsys/grafana-monitoring-stack/main/install_monitoring.sh](https://github.com/almsys/grafana-monitoring-stack/blob/master/install_monitoring.sh)
